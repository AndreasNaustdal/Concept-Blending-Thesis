...
\begin{figure} \centering \includegraphics[width=0.7\linewidth]{"Figures/Harp_ViolinOptimal"} \caption{Top suggestion when blending Harp and Violin. It suggests to move top property \emph{bow} (in red) from Violin to Harp } \label{fig:Harp-Violin} \end{figure}
...
\begin{figure} \centering \includegraphics[width=0.7\linewidth]{"Figures/Guitar_Violin"} \caption{Top suggestion when blending Guitar and Violin. It suggests to move top property pick (in red) from Guitar to Violin } \label{fig:Guitar-Violin} \end{figure}
